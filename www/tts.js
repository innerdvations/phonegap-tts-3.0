...
cordova.define("cordova/plugin/tts",
  function(require, exports, module) {
    ...
    /**
     * Synthesize speech directly to file (absolute path required)
     * 
     * @param {DOMString} text
     * @param {DOMString} file
     * @param {Object} successCallback
     * @param {Object} errorCallback
     */
    TTS.prototype.synthesizeToFile = function(text, file, successCallback, errorCallback) {
         return exec(successCallback, errorCallback, "TTS", "synthesizeToFile", [text, file]);
    };
    ...
    /**
     * Gets the state of the TTS service.
     * 
     * @param {Object} successCallback
     * @param {Object} errorCallback
     */
     ...
     * @param {Object} errorCallback
     */
    TTS.prototype.isSpeaking = function(successCallback, errorCallback) {
         return exec(successCallback, errorCallback, "TTS", "isSpeaking", []);
    };

    /**
     * Gets limit of length of input string passed to speak and synthesizeToFile.
     * 
     * @param {Object} successCallback
     * @param {Object} errorCallback
     */
    TTS.prototype.getMaxSpeechInputLength = function(successCallback, errorCallback) {
         return exec(successCallback, errorCallback, "TTS", "getMaxSpeechInputLength", []);
    };
